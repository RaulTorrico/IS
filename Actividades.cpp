...
void eliminarActividad() {
    ...
    while (getline(archivoEntrada, linea)) {
        ...
        if (linea.find(nombreActividad) != std::string::npos) {
            // Si se encuentra, marca la actividad como encontrada
    ...
    if (!actividadEncontrada) {
        std::cout << "La actividad '" << nombreActividad << "' no existe en el archivo." << std::endl;
        // Elimina el archivo temporal, ya que no se necesita
